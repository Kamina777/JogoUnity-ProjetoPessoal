...
public class EscolhaDaArma : MonoBehaviour
{
    ...
    public void ListandoArmasChild()
    {
        ...
        for (int i = 0; i < quantidadeArmas; i++) // nunca quero que o soco entra na lista, por isso come�a i = 1
        {
    ...
    {
        escolhaDaArma = Random.Range(0, tiposDeArma.Count); // COME�A NO 1 PRA N�O TIRAR O SOCO
